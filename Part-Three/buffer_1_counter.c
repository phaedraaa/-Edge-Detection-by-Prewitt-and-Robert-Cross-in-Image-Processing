...
int buffer_current_line_access;
int buffer_block_3x3_access;
...
int main()
{
    ...
    printf("buffer_current_line_access: %d\n", buffer_current_line_access);
    printf("buffer_block_3x3_access: %d\n", buffer_block_3x3_access);
